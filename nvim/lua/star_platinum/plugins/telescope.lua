return {
	...
	config = function()
		...
		local customBufferWithDelete = function()
			builtin.buffers({
		...
		keymap.set("n", "<leader>fb", customBufferWithDelete, { desc = "[ ] Find existing buffers" })
		...
		keymap.set("n", "<leader>fk", ":Telescope keymaps<CR>", { desc = "[T]elescope keymaps" })
